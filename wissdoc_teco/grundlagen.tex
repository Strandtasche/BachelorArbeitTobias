...
Auf Grund seines großen Marktanteil wird sich diese Arbeit auf das Android Betriebssystem fokussieren.
...
\par
Die Wahl von Studentinnen als Zielgruppe ist auf Grund ihrer Rolle als Innovators und Early Adopters von neuen Technologien bei einer solchen Studie sehr zielführend.
...
\subsection*{Personality and Self reported Mobile Phone Use}
...
Zur Bestimmung der Facettenwerte wurde John's (1991) Big Five Personality Inventory auf Grund seiner geringen Komplexität und schnellen Durchführbarkeit gewählt.
...
Im Laufe dieser acht Monate werden auf den Nokia N95 Smartphones der Probanden eine breite Menge an Daten bezüglich Anrufen, SMS, Applikationen und Bluetooth gesammelt, 
...
Es verfügt weder über einen Touchscreen noch über Multitasking und entspricht, wie in Abbildung \ref{nokia} zu sehen, nicht dem, was man heutzutage als Smartphone bezeichnen würde.
...
\subsection*{StudentLife: Assessing Mental Health, Academic Performance and Behavioral Trends of College Students using Smartphones}
...
Aus den betrachteten Arbeiten können diese Schlüsse gezogen werden:
Die Quantifizierung von Persönlichkeit ist ein erprobtes Feld, auf dem man sich an die bereits geleistete Forschung halten kann.
Das Sammeln von Daten direkt auf dem Smartphone ist Selbsteinschätzungen vorzuziehen, selbst wenn dadurch die benötigte Studiendauer steigt und es nicht möglich ist ähnlich viele Probandinnen zu befragen.
Keine der betrachteten Arbeiten legt Wert auf Kommunikation, die über Messaging Applikationen oder Social Media geschieht.
Butt und Lane ignorieren diese komplett, Ehrenberg fragt genau einen Datenpunkt, nämlich die mit Instant Messaging verbrachte Zeit, ab.
Chittaranjan ermittelt zumindest die Anzahl, wie oft Messenger Applikationen geöffnet werden, mehr jedoch nicht und Wang betrachtet Smartphones mehr als Sensorarray als als Kommunikationsgerät.
In dieser Arbeit soll die Betrachtung von Kommunikationsapplikationen und Social Media mit dem Detailgrad geschehen der notwendig ist um gehaltvolle Aussagen treffen zu können und der ihnen bisher vorenthalten wurde.

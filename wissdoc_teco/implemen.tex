...
Da nicht davon ausgegangen werden kann, dass alle Probandinnen über Smartphones mit ähnlicher oder höherer Leistung verglichen mit dem OnePlus One haben, muss die Applikation auch auf weniger starken Geräten einwandfrei funktionieren.
Dies ist unabwendbar um den komplikationsfreie Ablauf der Studie zu gewährleisten und mögliche Verluste von gesammelten Daten zu vermeiden.
 

\section{Vorstudie}

Gegen Ende der Implementierung, nach dem groben Testen aller zu implementierenden Funktionalitäten, wurde eine kleine Vorstudie durchgeführt um potenzielle Probleme bei der Hauptstudie frühzeitig zu entdecken und zu beheben, bevor sie negativen Einfluss auf die eigentliche Studie nehmen können.
...
Die Auswahl der zu betrachtenden Applikationen ist bereits mit dem Gedanken im Hinterkopf implementiert worden, das man potenziell später nocheinmal etwas hinzufügen oder entfernen will und ist dementsprechend modular.
